...
import { MapPin, Wallet, Calendar, Utensils, Train, Target, Briefcase } from "lucide-react";
...
const InputForm = ({ onSubmit }: InputFormProps) => {
  ...
  return (
    ...
    >
      ...
      <HeroButton type="submit" size="xl" className="w-full">
