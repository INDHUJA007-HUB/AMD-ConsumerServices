...
var HttpProtocol = class extends SerdeContext {
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./event-streams-PSHPT5XI.js");
...
var createAggregatedClient = (commands2, Client2, options) => {
  ...
  const { paginators: paginators2 = {}, waiters = {} } = options ?? {};
...
var ProtocolLib = class {
  ...
  decorateServiceException(exception, additions = {}) {
    ...
    if (this.queryCompat) {
      ...
      error.Error = {
        ...error.Error,
        Type: (_a = error.Error) == null ? void 0 : _a.Type,
        Code: (_b = error.Error) == null ? void 0 : _b.Code,
        Message: ((_c2 = error.Error) == null ? void 0 : _c2.message) ?? ((_d = error.Error) == null ? void 0 : _d.Message) ?? msg
      };
  ...
  _read(schema, value) {
    ...
    if (isObject) {
      ...
      if (ns.isMapSchema()) {
        ...
        const out = {};
        const sparse = !!ns.getMergedTraits().sparse;
        for (const [_k2, _v] of Object.entries(value)) {
          if (sparse || _v != null) {
            out[_k2] = this._read(mapMember, _v);
          }
        }
        return out;
      }
  ...
  _write(schema, value, container) {
    ...
    if (isObject) {
      ...
      if (ns.isMapSchema()) {
        ...
        for (const [_k2, _v] of Object.entries(value)) {
          if (sparse || _v != null) {
            out[_k2] = this._write(mapMember, _v);
          }
        }
        return out;
      }
