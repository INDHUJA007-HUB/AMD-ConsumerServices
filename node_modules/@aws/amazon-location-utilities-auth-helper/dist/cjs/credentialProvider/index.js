...
exports.withCredentialProvider = withCredentialProvider;
const authHelper_1 = require("../common/authHelper");
/**
 ...
 */
async function withCredentialProvider(credentialProvider, region) {
    return (0, authHelper_1.buildAuthHelper)(credentialProvider, region);
}
