 ...
 */
export function createTransformRequest(region, getCredentials) {
 ...
 */
export async function setupCredentialRefresh(credentialProvider) {
    let credentials;
 ...
 */
export async function buildAuthHelper(credentialProvider, region) {
